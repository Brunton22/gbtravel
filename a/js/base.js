...
//registering
	...
	//registering actions
		...
		$('.login_register_phone').on("click", function(){
			$('.pop_up_login_register').fadeIn('slide');
		})

		$('.normal_register').on("click", function(){
			$('.pop_up_box_normal').fadeIn('slide');
		})
